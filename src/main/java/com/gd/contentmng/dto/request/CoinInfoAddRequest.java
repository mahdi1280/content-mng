...
public class CoinInfoAddRequest implements Serializable {
    ...
    public CoinInfoAddRequest(String title, String description, List<String> metas, String path, List<String> tags, int coinId) {
        this.title = title;
    ...
    public static class Builder {
        ...
        public CoinInfoAddRequest build() {
            return new CoinInfoAddRequest(title, description, metas, path, tags, coinId );
        }
