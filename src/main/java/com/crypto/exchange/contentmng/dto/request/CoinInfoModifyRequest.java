...
public class CoinInfoModifyRequest implements Serializable {
    ...
    public CoinInfoModifyRequest(long id, String title, String description, String canonical, String lang, LinkModifyRequest link) {
        this.id = id;
        this.title = title;
    ...
    @Size(min = 1,max = 5,message = "{coin.info.modify.request.lang.size}")
